...
export enum AgentSessionProviders {
	...
	AgentHostOpenPolvo = 'agent-host-openpolvo',
}
...
export function getAgentSessionProvider(sessionResource: URI | string): AgentSessionProviders | undefined {
	...
	switch (type) {
		...
		case AgentSessionProviders.AgentHostOpenPolvo:
			return type;
		default:
			return undefined;
	}
...
export function getAgentSessionProviderName(provider: AgentSessionTarget): string {
	switch (provider) {
		...
		case AgentSessionProviders.AgentHostOpenPolvo:
			return localize('chat.session.providerLabel.agentHostOpenPolvo', "Polvo");
		default:
			return provider;
	}
}
