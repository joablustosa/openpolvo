...
from openpolvointeligence.graphs.conversation_reply_state import ConversationReplyState
...
_PROMPTS = Path(__file__).resolve().parent.parent / "prompts" / "conversation_reply"
