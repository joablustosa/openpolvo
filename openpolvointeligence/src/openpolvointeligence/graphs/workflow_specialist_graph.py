...
from openpolvointeligence.graphs.workflow_specialist_state import WorkflowSpecialistState

_logger = logging.getLogger(__name__)
_PROMPTS = Path(__file__).resolve().parent.parent / "prompts" / "workflow_specialist"
